...
function TooltipContent({
  className,
  sideOffset = 4, // Aumentei levemente o offset para afastar do botão
  children,
  ...props
    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          ...
          // Estilo padrão (você pode sobrescrever passando className)
      ...
      >
        {children}
        {/* A TooltipPrimitive.Arrow foi removida daqui */}
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
